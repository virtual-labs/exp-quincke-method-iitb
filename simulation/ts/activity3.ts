...
function activity3() {
	...
	record_btn = <HTMLButtonElement> document.getElementById('rbtn');
}
...
function add_offcanvas_table(x: any) {
	...
	let ele: HTMLDivElement = <HTMLDivElement> document.getElementsByClassName('bi bi-arrow-bar-left offcanvasicon')[1];
	ele.className = '';
	ele.innerHTML = 'Table'; 
...
function load_canvas2_images() {
	...
	console.log(my_canvas2.width, my_canvas2.height);
	n_rings = new Chemistry.Quinkes_Method(
		8,
		noise,
		'white',
		new Chemistry.Point(
			my_canvas2.width / (2 * lscale) + 5,
			(my_canvas2.height + 105) / (2 * lscale)
		),
		my_canvas2
	);
...
function update_vsr() {
	let ele: HTMLInputElement = <HTMLInputElement> document.getElementById('vsr-inp');

	let ele1: HTMLInputElement = <HTMLInputElement> document.getElementById('msr-inp');
...
function vsr_error(): boolean {

	let err: number = (Math.abs(current_dataset[3][i_index] - current_vsr) / current_dataset[3][i_index]) * 100;
	console.log(err);
...
function record_observation() {
	...
	if(obs_table.length == 5) {
		let ele: HTMLDivElement = document.createElement('div') as HTMLDivElement;
...
function disable_buttons() {
	...
	let btn1: HTMLButtonElement = <HTMLButtonElement> document.getElementById('a2-btn-up');
	let btn2: HTMLButtonElement = <HTMLButtonElement> document.getElementById('a2-btn-fine-up');

	let btn3: HTMLButtonElement = <HTMLButtonElement> document.getElementById('a2-btn-down');
	let btn4: HTMLButtonElement = <HTMLButtonElement> document.getElementById('a2-btn-fine-down');

	let btn5: HTMLButtonElement = <HTMLButtonElement> document.getElementById('a2-btn-up');
	let btn6: HTMLButtonElement = <HTMLButtonElement> document.getElementById('a2-btn-fine-up');

	
	let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('rtbn');
	let btn0: HTMLButtonElement = <HTMLButtonElement> document.getElementById('dbtn');
...
function increase_current() {
	let idsp: HTMLInputElement = <HTMLInputElement> document.getElementById('i-dsp');
	let bdsp: HTMLInputElement = <HTMLInputElement> document.getElementById('b-dsp');
