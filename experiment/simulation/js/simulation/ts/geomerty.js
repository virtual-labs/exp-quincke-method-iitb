...
(function (Chemistry) {
    ...
    class Quinkes_Method extends Geometry {
        ...
        draw() {
            //this.multiplier = this.d[3] * 1000;
            this.context.lineWidth = 2;
            //draw
            this.context.strokeStyle = this.color;
            this.context.drawImage(drop, ((this.stpt.x / 2 + 62) * lscale) / 2, (this.stpt.y + this.d) * lscale, 349 * lscale * 1.5, -93 * lscale * 1.5);
            this.context.stroke();
            this.context.strokeStyle = 'black';
            // for(let i=0; i<this.n; i++) {
            ...
            // 	this.context.drawImage(drop, this.stpt.x*lscale, this.d[i]*this.multiplier*lscale/2);
            // 	this.context.stroke();
            // 	this.context.strokeStyle = 'black';
            // }
            this.context.lineWidth = 1;
    ...
    Chemistry.Quinkes_Method = Quinkes_Method;
